...
namespace CodeGenerator.Utilities
{
    public static class ControllerFileService
    {
        ...
        private static string CreateControllerFileContent(string fileName, string projectName)
        {
            ...
            stringBuilder.AppendLine("using CustomBaseController;");
            ...
            stringBuilder.AppendLine($"public class {fileName}Controller : MsmControllerBase");
            stringBuilder.AppendLine("{");
            ...
            stringBuilder.AppendLine($"return ReturnResult(result);");
